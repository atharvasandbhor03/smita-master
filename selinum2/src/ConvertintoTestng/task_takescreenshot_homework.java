...
public class task_takescreenshot_homework {
	@Test
	public void abmethod() throws InterruptedException, IOException, AWTException
	{
	...
	Thread.sleep(3000);
	driver.findElement(By.xpath("//input[@placeholder='Search for Products...']")).sendKeys("Mangos"+Keys.ENTER );
...
//	r1.keyRelease(KeyEvent.VK_ENTER);
	...
	File des=new File("./screenshot/addtocarttestng4.png");
	FileHandler.copy(src, des);
	Thread.sleep(3000);
	driver.findElement(By.id("multifor")).sendKeys("9527710027");
	Thread.sleep(3000);
	driver.quit();
